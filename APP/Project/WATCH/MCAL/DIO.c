...
u8 MDIO_U8GetBitDirection(u8 A_U8PortNAME , u8 A_PinNO)
{
	u8 PINValue;
	switch( A_U8PortNAME )
	{
		case PORTA:
				PINValue = Get_Bit( DIO_DDRA_REG , A_PinNO ) ; break;
		case PORTB:
				PINValue = Get_Bit( DIO_DDRB_REG , A_PinNO ) ; break;
		case PORTC:
				PINValue = Get_Bit( DIO_DDRC_REG , A_PinNO ) ; break;
		case PORTD:
				PINValue = Get_Bit( DIO_DDRD_REG , A_PinNO ) ; break;
